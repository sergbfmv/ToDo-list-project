...
test("title of specified task should be changed", () => {
  const action = tasksActions.updateTaskAC({ taskId: "2", model: { title: "yogurt" }, todolistId: "todolistId2" });
...
test("tasks should be added for todolist", () => {
  const action = tasksActions.getTasksAC({ tasks: startState["todolistId1"], todolistId: "todolistId1" });
