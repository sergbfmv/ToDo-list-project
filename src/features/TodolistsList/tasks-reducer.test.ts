...
test("correct task should be deleted from correct array", () => {
  const taskPayload = { taskId: "2", todolistId: "todolistId2" };
  const action = tasksThunks.removeTask.fulfilled(taskPayload, "requestId", taskPayload);
...
test("title of specified task should be changed", () => {
  const taskPayload = { taskId: "2", domainModel: { title: "yogurt" }, todolistId: "todolistId2" };
  const action = tasksThunks.updateTask.fulfilled(taskPayload, "requestId", taskPayload);
